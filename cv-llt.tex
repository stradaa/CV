...
\mynames{Estrada/Alejandro\bibnamedelima Estrada,
  Lim/Lian\bibnamedelima Tze,
...
\leftheader{%
  {\LARGE\bfseries\sffamily Alex Estrada Berlanga, Ph.D. Candidate}

  \makefield{\faEnvelope[regular]}{\href{mailto:aestra@seas.upenn.edu}{\texttt{aestra@seas.upenn.edu}}}
  % \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}
  \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/alex-estradaa6/}{\texttt{alex-estradaa6}}}
  \makefield{\faGithubSquare}{\href{https://github.com/stradaa}{\texttt{stradaa}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://alejandroaestrada.com/}}
